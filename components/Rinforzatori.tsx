...
export default function Rinforzatori() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 600, margin: "auto" }}>
      <h2 style={{ fontSize: "1.5rem", marginBottom: 16 }}>🧠 Inserisci rinforzatori per il tuo cane</h2>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        ...
        <button
          ...
          style={{ padding: 8, background: "#28a745", color: "white", fontWeight: "bold", borderRadius: 4 }}
        >
          ➕
        </button>
      </div>
